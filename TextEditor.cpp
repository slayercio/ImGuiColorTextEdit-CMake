...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::FiveMLua()
{
	static bool inited = false;
	static LanguageDefinition langDef;
	if (!inited)
	{
		...
		static const char* const citizen_identifiers[] = {
			"Citizen", "Player", "Entity", "Vehicle", "Ped", "Object", "Blip", "Checkpoint", "Pickup", "GamePool", "GetEntityCoords", "GetEntityHeading", "GetEntityModel", "GetEntityType",
			"GetEntityHealth", "GetEntityMaxHealth", "GetEntityRotation", "GetEntityRotationVelocity", "GetEntityVelocity", "GetEntityMatrix", "GetEntityBoneIndex", "GetEntityBonePosition", "GetEntityBoneRotation", "GetEntityBoneRotationVelocity",
			"GetEntityBoneVelocity", "GetEntityBoneMatrix", "GetEntityBonePositionAndRotation", "GetEntityBonePositionAndRotation", "GetEntityBonePositionAndRotationMatrix",
			"CreateThread", "Wait", "SetTimeout", "SetInterval", "ClearInterval", "IsThreadActive", "GetCurrentResourceName", "GetInvokingResource", "GetNumPlayerIdentifiers", "GetPlayerIdentifier",
		};
		for (auto& k : citizen_identifiers)
		{
			Identifier id;
			id.mDeclaration = "FiveM built-in function";
			langDef.mIdentifiers.insert(std::make_pair(std::string(k), id));
		}
